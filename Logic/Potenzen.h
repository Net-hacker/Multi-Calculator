	...
	public:
		void WAdd()
		{
			...
			switch (option) {
				...
				cout << "Das Ergebnis von die Wurzel aus " << x << " " << mal << " die Wurzel aus " << y << " = " << result << endl;
				system("pause");
				x = 0;
				y = 0;
				result = 0;
				...
				cout << "Das Ergebnis von die Wurzel aus " << x << " " << durch << " die Wurzel aus " << y << " = " << result << endl;
				system("pause");
				x = 0;
				y = 0;
				result = 0;
		...
		void Quack()
		{
			...
			cin >> x;
			result = Q.Quad(x);
			cout << x << " " << mal << " " << x << " oder " << x << hoch << " = " << result << endl;
			system("pause");
			x = 0;
			result = 0;
		}
